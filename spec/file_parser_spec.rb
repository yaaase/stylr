...
describe FileParser do
  ...
  context "sample_pass2" do
    before(:each) do
      @string = "/home/mark/langs/ruby/rslint/txt/sample_pass2.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail2" do
    before(:each) do
      @string = "/home/mark/langs/ruby/rslint/txt/sample_fail2.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail3" do
    before(:each) do
      @string = "/home/mark/langs/ruby/rslint/txt/sample_fail3.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail4" do
    before(:each) do
      @string = "/home/mark/langs/ruby/rslint/txt/sample_fail4.rb"
      @f = FileParser.new(@string, Lint.new)
    end
