...
describe FileParser do
  context "sample_1" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_1.rb"
  ...
  context "sample_fail" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_fail.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_pass2" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_pass2.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail2" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_fail2.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail3" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_fail3.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail4" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_fail4.rb"
      @f = FileParser.new(@string, Lint.new)
    end
  ...
  context "sample_fail5" do
    before(:each) do
      @string = "/Users/Thoughtworker/rslint/txt/sample_fail5.rb"
      @f = FileParser.new(@string, Lint.new)
    end
